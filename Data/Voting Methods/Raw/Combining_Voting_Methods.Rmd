...
methods_2021 <- readxl::read_xlsx("2021_annual_meeting_voting_methods.xlsx", skip = 2) |>
  slice(-1) |>
  mutate(year = 2021)

methods_2022 <- readxl::read_xlsx("2022_annual_meeting_voting_methods.xlsx", skip = 2) |>
  mutate(year = 2022)

methods_2023 <- readxl::read_xlsx("2023_annual_meeting_voting_methods.xlsx", skip = 2) |>
  mutate(year = 2023)

methods_2024 <- readxl::read_xlsx("2024_annual_meeting_voting_methods.xlsx", skip = 3) |>
  mutate(year = 2024)
...
combined_df <- bind_rows(
  ...
  methods_2020, methods_2022, methods_2023,
  methods_2024, methods_2025
)
