...
methods_2019 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2019)

methods_2020 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2020)
  
methods_2021 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2021)
  
methods_2022 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2022)
  
methods_2023 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2023)
  
methods_2024 <- readxl::read_xlsx("2018_annual_meeting_voting_methods.xlsx", skip = 1) |> 
  slice(-1) |> 
  mutate(year = 2024)
